...
def get_expected_calls() -> List[Call]:
    call1 = CallBuilder().in_green_list() \
        ...
        .call_risk_score(0.431513435443) \
        .call_datetime(datetime.strptime('2020-10-12T07:20:50.52Z', DATETIME_FORMAT)) \
        .call_id('2c4fae60-cf43-4f27-869e-a9ed8b0ca25b') \
        .build()

    call2 = CallBuilder().in_red_list() \
        .phone_number('+44123456789') \
        .call_risk_score(0.123444) \
        .call_datetime(datetime.strptime('2019-10-12T07:20:50.52Z', DATETIME_FORMAT)) \
